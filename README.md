...
Normalement, l’installation de meteor est automatisée. Un fichier msi est disponible ici : 
[https://www.meteor.com/install](https://www.meteor.com/install)

Suivez les étapes sans sourciller.
...
Bon, comme vous avez été sages... On va vous donner un moyen simple de déployer une application développée sous meteor.

L’équipe du projet a eu la bonne idée de mettre un serveur à disposition des développeurs pressés comme nous, un serveur. Pour envoyer le colis, rien de plus simple :
...
La commande va empaqueter et minifier votre projet puis uploader le tout vers les serveurs du projet. Votre application sera accessible à l’adresse pong.meteor.com.
...
Une référence sur Spacebar (templates) :
[https://www.discovermeteor.com/blog/spacebars-secrets-exploring-meteor-new-templating-engine/](https://www.discovermeteor.com/blog/spacebars-secrets-exploring-meteor-new-templating-engine/)

Un tutoriel concis :
[http://blog.appliedis.com/2014/05/15/meteorjs-making-single-page-applications-that-are-fun-to-build/](http://blog.appliedis.com/2014/05/15/meteorjs-making-single-page-applications-that-are-fun-to-build/)
